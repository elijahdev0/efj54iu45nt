...
class Bootstrap extends SocialNetworkAddon
{
    ...
    protected $name = 'X (Twitter)';
    protected $icon = 'fab fa-twitter';
    protected $sort = 30;

    public function init ()
    {
        Route::post( 'social-networks/twitter/settings', [ Controller::class, 'saveSettings' ] );
        Route::get( 'social-networks/twitter/settings', [ Controller::class, 'getSettings' ] );
        Route::post( 'social-networks/twitter/channel-via-cookie', [ Controller::class, 'addChannelViaCookie' ] );
