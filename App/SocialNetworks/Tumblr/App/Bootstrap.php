...
class Bootstrap extends SocialNetworkAddon
{
    ...
    {
        Route::post( 'social-networks/tumblr/settings', [ Controller::class, 'saveSettings' ] );
        Route::get( 'social-networks/tumblr/settings', [ Controller::class, 'getSettings' ] );
