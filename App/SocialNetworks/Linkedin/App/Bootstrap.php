...
class Bootstrap extends SocialNetworkAddon
{
    ...
    protected $icon = 'fab fa-linkedin-in';
    protected $sort = 50;

    public function init ()
    {
        Route::post( 'social-networks/linkedin/settings', [ Controller::class, 'saveSettings' ] );
        Route::get( 'social-networks/linkedin/settings', [ Controller::class, 'getSettings' ] );
