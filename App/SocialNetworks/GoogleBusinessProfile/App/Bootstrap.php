...
{
    protected $slug = 'google_b';
    protected $name = 'Google Business Profile';
    protected $icon = 'fab fa-google';
    protected $sort = 130;

    public function init ()
    {
        Route::post( 'social-networks/google_b/settings', [ Controller::class, 'saveSettings' ] );
        Route::get( 'social-networks/google_b/settings', [ Controller::class, 'getSettings' ] );
