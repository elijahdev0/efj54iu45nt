...
{
    protected $slug = 'threads';
    protected $name = 'Threads';
    protected $icon = 'fab fa-threads';
    protected $sort = 20;

    public function init ()
    {
        Route::post( 'social-networks/threads/settings', [ Controller::class, 'saveSettings' ] );
        Route::get( 'social-networks/threads/settings', [ Controller::class, 'getSettings' ] );
