...
{
    protected $slug = 'blogger';
    protected $name = 'Blogger';
    protected $icon = 'fab fa-blogger';
    protected $sort = 170;

    public function init ()
    {
        Route::post( 'social-networks/blogger/settings', [ Controller::class, 'saveSettings' ] );
        Route::get( 'social-networks/blogger/settings', [ Controller::class, 'getSettings' ] );
