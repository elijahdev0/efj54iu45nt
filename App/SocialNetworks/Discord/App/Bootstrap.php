...
class Bootstrap extends SocialNetworkAddon
{
    ...
    {
        Route::post( 'social-networks/discord/settings', [ Controller::class, 'saveSettings' ] );
        Route::get( 'social-networks/discord/settings', [ Controller::class, 'getSettings' ] );
