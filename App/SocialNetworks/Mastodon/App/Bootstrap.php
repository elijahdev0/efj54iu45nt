...
{
    protected $slug = 'mastodon';
    protected $name = 'Mastodon';
    protected $icon = 'fab fa-mastodon';
    protected $sort = 200;

    public function init ()
    {
        Route::post( 'social-networks/mastodon/settings', [ Controller::class, 'saveSettings' ] );
        Route::get( 'social-networks/mastodon/settings', [ Controller::class, 'getSettings' ] );
